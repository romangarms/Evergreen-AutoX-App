...
- Apple's user-generated-content rules are why the app has the guidelines gate (`GuidelinesGate`), report sheets (`POST /api/leaderboard/reports`, listed in the dev console's Reports panel), and a local "hide leaderboard" option. Keep those reachable when reworking the leaderboard UI.
